...
public class NetFlixTopTenMoviesMapperSorter extends Mapper<LongWritable, Text, FloatWritable, IntWritable>{
    ...
    private FloatWritable new_key = new FloatWritable();
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        new_key.set(Float.parseFloat(values[1]));
        new_value.set(Integer.parseInt(values[0]));
